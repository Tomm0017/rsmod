package gg.rsmod.plugins.osrs.content.combat.strategy.ranged.weapon

import gg.rsmod.plugins.osrs.api.cfg.Items
import gg.rsmod.plugins.osrs.content.combat.strategy.ranged.ammo.Bolts.ADAMANT_BOLTS
import gg.rsmod.plugins.osrs.content.combat.strategy.ranged.ammo.Bolts.BLURITE_BOLTS
import gg.rsmod.plugins.osrs.content.combat.strategy.ranged.ammo.Bolts.BOLT_RACKS
import gg.rsmod.plugins.osrs.content.combat.strategy.ranged.ammo.Bolts.BONE_BOLTS
import gg.rsmod.plugins.osrs.content.combat.strategy.ranged.ammo.Bolts.BROAD_BOLTS
import gg.rsmod.plugins.osrs.content.combat.strategy.ranged.ammo.Bolts.BRONZE_BOLTS
import gg.rsmod.plugins.osrs.content.combat.strategy.ranged.ammo.Bolts.DRAGON_BOLTS
import gg.rsmod.plugins.osrs.content.combat.strategy.ranged.ammo.Bolts.IRON_BOLTS
import gg.rsmod.plugins.osrs.content.combat.strategy.ranged.ammo.Bolts.KEBBIT_BOLTS
import gg.rsmod.plugins.osrs.content.combat.strategy.ranged.ammo.Bolts.MITHRIL_BOLTS
import gg.rsmod.plugins.osrs.content.combat.strategy.ranged.ammo.Bolts.RUNITE_BOLTS
import gg.rsmod.plugins.osrs.content.combat.strategy.ranged.ammo.Bolts.STEEL_BOLTS
