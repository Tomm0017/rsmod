...
onButton(parent = OptionsTab.ADVANCED_INTERFACE_ID, child = 4) {
    it.player().toggleVarbit(OSRSGameframe.CHATBOX_SCROLLBAR_VARBIT)
}

onButton(parent = OptionsTab.ADVANCED_INTERFACE_ID, child = 6) {
    it.player().toggleVarbit(OSRSGameframe.DISABLE_SIDEPANELS_OPAQUE_VARBIT)
}

onButton(parent = OptionsTab.ADVANCED_INTERFACE_ID, child = 8) {
    it.player().toggleVarbit(OSRSGameframe.DISABLE_XP_TILL_LEVEL_VARBIT)
}

onButton(parent = OptionsTab.ADVANCED_INTERFACE_ID, child = 10) {
    it.player().toggleVarbit(OSRSGameframe.DISABLE_PRAYER_TOOLTIP_VARBIT)
}

onButton(parent = OptionsTab.ADVANCED_INTERFACE_ID, child = 12) {
    it.player().toggleVarbit(OSRSGameframe.DISABLE_SPECIAL_ATTACK_TOOLTIP_VARBIT)
}

onButton(parent = OptionsTab.ADVANCED_INTERFACE_ID, child = 16) {
    val p = it.player()
...
onButton(parent = OptionsTab.ADVANCED_INTERFACE_ID, child = 18) {
    it.player().toggleVarbit(OSRSGameframe.CHATBOX_TRANSPARENT_VARBIT)
}

onButton(parent = OptionsTab.ADVANCED_INTERFACE_ID, child = 20) {
    it.player().toggleVarbit(OSRSGameframe.CHATBOX_SOLID_VARBIT)
}

onButton(parent = OptionsTab.ADVANCED_INTERFACE_ID, child = 21) {
    val p = it.player()
...
onButton(parent = OptionsTab.ADVANCED_INTERFACE_ID, child = 23) {
