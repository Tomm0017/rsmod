...
class MessageEncoderSet {
    ...
    fun init(structures: MessageStructureSet) {
        ...
        encoders[SetInterfaceAnimationMessage::class.java] = InterfaceAnimationEncoder(structures.get(SetInterfaceAnimationMessage::class.java)!!)
        encoders[SetInterfaceItemMessage::class.java] = InterfaceItemEncoder(structures.get(SetInterfaceItemMessage::class.java)!!)
        encoders[SetInterfaceNpcMessage::class.java] = InterfaceNpcEncoder(structures.get(SetInterfaceNpcMessage::class.java)!!)
