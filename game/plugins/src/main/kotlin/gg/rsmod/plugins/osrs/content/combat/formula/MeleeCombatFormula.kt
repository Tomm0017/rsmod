...
object MeleeCombatFormula : CombatFormula {
    ...
    private fun getEquipmentAttackBonus(pawn: Pawn): Double {
        ...
        val bonus = when (combatStyle) {
            ...
            CombatStyle.MAGIC -> BonusSlot.ATTACK_MAGIC
            CombatStyle.RANGED -> BonusSlot.ATTACK_RANGED
            CombatStyle.NONE -> throw IllegalStateException("Pawn has no set combat style.")
        }
    ...
    private fun getEquipmentDefenceBonus(pawn: Pawn, target: Pawn): Double {
        ...
        val bonus = when (combatStyle) {
            ...
            CombatStyle.MAGIC -> BonusSlot.DEFENCE_MAGIC
            CombatStyle.RANGED -> BonusSlot.DEFENCE_RANGED
            CombatStyle.NONE -> throw IllegalStateException("Pawn has no set combat style.")
        }
