...
class InstancedChunkSet(val regionSize: Int, val values: Map<Int, InstancedChunk>) {
    ...
    companion object {
        ...
        private fun getCoordinates(x: Int, z: Int, height: Int): Int = ((height and 0x3) shl 28) or (x shl 14) or (z)
    }
    ...
    class Builder {
        ...
        fun set(chunkX: Int, chunkZ: Int, height: Int = 0, rotation: Int = 0, copy: Tile): Builder {
            ...
            val packed = ((copy.height and 0x3) shl 24) or ((x and 0x3FF) shl 14) or ((z and 0x7FF) shl 3) or
