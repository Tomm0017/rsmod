...
suspend fun who_are_you(it: Plugin) {
...
suspend fun question(it: Plugin) {
...
suspend fun what_is_achievement_diary(it: Plugin) {
...
suspend fun what_are_rewards(it: Plugin) {
...
suspend fun easy_rewards(it: Plugin) {
...
suspend fun medium_rewards(it: Plugin) {
...
suspend fun hard_rewards(it: Plugin) {
...
suspend fun elite_rewards(it: Plugin) {
...
suspend fun claim_rewards(it: Plugin) {
