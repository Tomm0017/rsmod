...
suspend fun QueueTask.produceItemBox(vararg items: Int, title: String = "What would you like to make?", logic: (Int, Int) -> Unit) {
    ...
    player.runClientScript(2046, 0, "$title${nameArray.joinToString("")}", 12, *itemArray)
